/**
 * Error Handling Utilities for Miro MCP Server
 */
 ...
 */
export class RateLimitError extends MiroApiError {
 ...
 */
export class AuthenticationError extends MiroApiError {
 ...
 * Not found error
 */
export class NotFoundError extends MiroApiError {
 ...
 * Validation error
 */
export class ValidationError extends MiroApiError {
